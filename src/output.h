...
/**
 * Cette fonction affiche le format 'text' sur stdout.
 * @param rep,
 * @param root,
 */
...
/**
 * Cette fonction affiche le format 'dot' sur stdout.
 * @param rep,
 * @param root,
 */
...
/**
 * Cette fonction imprime le format 'dot' dans un fichier.
 * @param rep,
 * @param filename,
 * @param root,
 */
...
/*
 * Cette fonction imprime le format 'text' dans un fichier.
 * @param rep,
 * @param filename,
 * @param root,
 */
